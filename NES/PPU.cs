    ...
    class PPU
    {
        ...
        public float Step()
        {
            ...
            else if (Y == Screen.Height + 1)
            {
                ...
                {
                    //condition ensures correct NMI disable delay when done
                    //near time when VBL is set - BLARGG test 08 - nmi_off_timing
        ...
        public void Poke(int addr, byte data)
        {
            ...
            switch (addr)
            {
                case 0:
                    ...
                    // VBL flag is cleared - BLARGG test 07-nmi_on_timing
