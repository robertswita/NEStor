...
namespace NES
{
    ...
    class Mapper_001 : Mapper_000
    {
        ...
        public override void Reset()
        {
            ...
            UpdateControl(ControlRegister | 0xC);
        }
        ...
        void UpdateChr0(int register)
        {
            ...
            {
                Bus.ChrMemory.Swap(0, ChrBank0 & ~0x1);
                Bus.ChrMemory.Swap(1, ChrBank0 | 0x1);
            }
        ...
        private void HandleSURomVariant(int register)
        {
            ...
            if (Bus.PrgMemory.SwapBanks.Count > 16 && (register & 0x10) != 0)
                isOuterBank = true;
