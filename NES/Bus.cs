...
namespace NES
{
    ...
    class Bus
    {
        ...
        public void LoadCartridge(string fileName)
        {
            ...
            var mapperID = mapperFlag1 >> 4;
            var submapper = 0;
            if ((mapperFlag2 >> 2 & 3) == 2) //Format iNES 2.0
            {
                submapper = reader.ReadByte();
                mapperID |= submapper << 8 & 0xF00 | mapperFlag2 & 0xF0;
                submapper >>= 4;
            ...
            {
                if ((mapperFlag2 & 0xF) == 0)
                    mapperID |= mapperFlag2 & 0xF0;
            ...
            switch (mapperID)
            {
                ...
                case 157:
                case 159:
                    Mapper = new Mapper_016(); // mapper for hacks of 66
